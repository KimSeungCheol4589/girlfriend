 ...
 */
export function useWishMutation<TPayload extends Record<string, unknown>, TData>(
  operation: string,
  action: (input: TPayload & { requestId: string }) => Promise<WishActionResult<TData>>,
